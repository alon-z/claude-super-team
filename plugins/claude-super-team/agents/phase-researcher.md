...
tools: Read, Write, Bash, Glob, Grep, WebSearch, WebFetch, Bash(firecrawl *)
model: opus
maxTurns: 40
memory: project
skills:
...
If Firecrawl CLI reference was loaded into your context via the preloaded skill, use it as your PRIMARY web research tool. Otherwise, fall back to WebSearch/WebFetch.
